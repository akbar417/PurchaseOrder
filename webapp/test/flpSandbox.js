		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#commytestpopurchaseorders-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commytestpopurchaseorders-display": {
								"semanticObject": "commytestpopurchaseorders",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mytest.po.purchaseorders",
									"url": sap.ui.require.toUrl("com/mytest/po/purchaseorders")
								}
							}
						}
					}
